...
namespace Latchet.Infrastructures.Tools.Localizations.Microsoft
{
    public class MicrosoftTranslator : ITranslator
    {
        ...
        public MicrosoftTranslator(IServiceScopeFactory serviceScopeFactory, IConfiguration configuration)
        {
            ...
            var assemblyQualifiedName = configuration["LatchetConfigurations:MicrosoftTranslator:ResourceKeyHolderAssemblyQualifiedTypeName"];
