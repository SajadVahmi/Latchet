...
using Latchet.Persistence.Sql.Command.OutBoxEventItems;
using Latchet.Persistence.Sql.Configurations;
...
namespace Latchet.Persistence.Sql.Command
{
        ...
        private void addEntityChangeInterceptorItems()
        {
            ...
            foreach (var entity in changedEntities)
            {
                var entityChageInterceptorItem = new EntityChageInterceptorItem
                {
                    ...
                    EntityId = entity.Property("Id").CurrentValue.ToString(),
